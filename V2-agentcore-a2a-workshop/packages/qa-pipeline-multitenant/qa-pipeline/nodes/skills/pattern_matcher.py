...
# Agent speaker markers used across nodes for speaker identification.
AGENT_MARKERS = ("상담사:", "상담사 :", "상담원:", "상담원 :", "agent:", "agent :", "직원:", "직원 :")
CUSTOMER_MARKERS = ("고객:", "고객 :", "customer:", "customer :", "손님:", "손님 :", "민원인:", "민원인 :")
...
def is_customer(line: str) -> bool:
    lower = line.lower()
    return any(m in lower for m in CUSTOMER_MARKERS)
...
def parse_turns(transcript: str) -> list[dict[str, Any]]:
    ...
    for line in transcript.strip().split("\n"):
        ...
        if is_customer(line_stripped):
            ...
            speaker = "unknown"
        turns.append({"speaker": speaker, "text": line_stripped, "turn": turn_number})
    return turns
